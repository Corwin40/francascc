 ...
 */
final class Version20200906102633 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE college_section DROP FOREIGN KEY FK_DF9DF0ED770124B2');
        ...
        $this->addSql('ALTER TABLE articles_section DROP FOREIGN KEY FK_68161E4E1EBAF6CC');
        $this->addSql('ALTER TABLE section DROP FOREIGN KEY FK_2D737AEFC4663E4');
        $this->addSql('ALTER TABLE college_section DROP FOREIGN KEY FK_DF9DF0EDD823E37A');
        $this->addSql('ALTER TABLE articles_section DROP FOREIGN KEY FK_68161E4ED823E37A');
