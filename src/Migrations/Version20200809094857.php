 ...
 */
final class Version20200809094857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE category ADD articles_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE articles ADD college_id INT DEFAULT NULL, CHANGE create_at create_at DATETIME DEFAULT NULL, CHANGE update_at update_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE articles ADD CONSTRAINT FK_BFDD3168770124B2 FOREIGN KEY (college_id) REFERENCES college (id)');
        $this->addSql('CREATE INDEX IDX_BFDD3168770124B2 ON articles (college_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_BFDD3168770124B2 ON articles');
        $this->addSql('ALTER TABLE articles DROP college_id, CHANGE create_at create_at DATETIME DEFAULT \'NULL\', CHANGE update_at update_at DATETIME DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE category DROP articles_id, CHANGE name name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
